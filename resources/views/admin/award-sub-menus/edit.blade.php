@extends('layouts.admin', ['title' => 'Edit Award sub-menu'])
...
<div class="card">
    <form method="POST" action="{{ route('admin.award-sub-menus.update', $subMenu) }}">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-2">
            ...
            <div>
                ...
                <input id="url" name="url" value="{{ old('url', $subMenu->url) }}" placeholder="/award/honorable-client">
