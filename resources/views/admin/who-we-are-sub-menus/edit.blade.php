@extends('layouts.admin', ['title' => 'Edit Who We Are sub-menu'])
...
<div class="card">
    <form method="POST" action="{{ route('admin.who-we-are-sub-menus.update', $subMenu) }}">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-2">
            ...
            <div>
                ...
                <input id="url" name="url" value="{{ old('url', $subMenu->url) }}" placeholder="/about-us">
