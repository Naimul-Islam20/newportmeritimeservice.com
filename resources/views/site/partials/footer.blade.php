<footer class="relative mt-auto overflow-hidden text-white">
    ...
    <div class="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1586528116311-ad8ed7c80bc2?q=80&w=2000&auto=format&fit=crop"
            alt="Port" class="h-full w-full object-cover object-center">
    ...
    <div class="relative z-10 bg-[#112a6d] text-[#b8c6e6] text-sm">
        <div class="site-container flex items-center justify-between">
            <div class="flex items-center">
                <span class="border-x border-[#213b86] px-6 py-2.5">
