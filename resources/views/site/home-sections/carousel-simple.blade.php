...
<section id="services" class="bg-white py-16 sm:py-24">
    <div class="site-container">
        <div>
            <h3 class="text-sm font-bold uppercase tracking-wider text-[#3eb0e3]">{{ $section->mini_title ?: 'Our Services' }}</h3>
            <h2 class="mt-2 font-sans text-4xl font-bold text-[#112a6d] sm:text-5xl">{{ $section->title ?: 'What We Do' }}</h2>
        </div>
    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="group relative flex h-[380px] w-full flex-col justify-between overflow-hidden rounded-xl bg-[#01223b] p-8 shadow-lg">
                            ...
                            <div class="relative z-10 flex h-full flex-col">
                                ...
                                @endif
                                <a href="{{ $item->resolvedHref() }}" class="mt-auto font-bold text-white transition hover:text-[#3eb0e3]">View details</a>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="swiper-slide">
                        <div class="flex h-[220px] w-full items-center justify-center rounded-xl border border-slate-100 bg-[#f7f8f9] p-8 text-center text-slate-600">
