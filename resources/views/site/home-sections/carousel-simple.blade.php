{{-- Simple carousel: menu sub-items as Gimaş-style white cards --}}
@php
    $carouselUid = 'home-carousel-'.$section->id;
    $sectionAnchor = match ($section->menu?->normalizedPath()) {
        '/our-services' => 'services',
        '/ship-supply' => 'ship-supply',
        default => $carouselUid,
    };
@endphp
<section id="{{ $sectionAnchor }}" class="services-carousel site-section bg-white">
    <div class="site-container">
        <div class="services-carousel__header">
            ...
            <div class="services-carousel__nav" aria-label="{{ $section->title ?: 'Carousel' }} controls">
                <button type="button" data-carousel-prev="{{ $carouselUid }}" class="services-carousel__arrow services-carousel__arrow--prev" aria-label="Previous slide">
                ...
                <button type="button" data-carousel-next="{{ $carouselUid }}" class="services-carousel__arrow services-carousel__arrow--next" aria-label="Next slide">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <div class="swiper services-swiper services-carousel__swiper" data-carousel="{{ $carouselUid }}">
