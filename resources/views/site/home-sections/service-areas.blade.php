...
@php($mapUrl = $mapPath !== '' && (str_starts_with($mapPath, 'http://') || str_starts_with($mapPath, 'https://')) ? $mapPath : ($mapPath !== '' ? public_upload_url($mapPath) : null))
@php($mapUrl = ($mapUrl ?? '') !== '' ? $mapUrl : null)
