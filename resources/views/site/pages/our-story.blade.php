...
@section('content')
    <section class="relative flex h-[300px] w-full items-center overflow-hidden bg-secondary sm:h-[400px]">
        @include('site.partials.page-hero-media', ['imageUrl' => $story->hero_background_url])
        <div class="relative z-10 site-container">
            ...
            @include('site.partials.page-hero-crumbs', ['path' => '/our-story', 'current' => $story->hero_title])
        </div>
    </section>
