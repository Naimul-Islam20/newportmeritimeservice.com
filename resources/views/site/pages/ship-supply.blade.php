    ...
    <section class="bg-white site-section">
        <div class="site-container">
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <!-- Card 1 -->
                <div class="flex flex-col rounded-2xl border border-foreground/10 bg-secondary/5 p-8 shadow-sm transition hover:shadow-md">
                    <!-- Icon -->
                    ...
                    <h4 class="text-xl font-bold uppercase text-secondary">MARINE LUBES AND<br>GREASES</h4>
                    ...
                    <a href="#" class="mt-8 text-sm font-bold text-secondary transition hover:text-primary">View details</a>
                </div>
                ...
                <div class="flex flex-col rounded-2xl border border-foreground/10 bg-secondary/5 p-8 shadow-sm transition hover:shadow-md">
                    ...
                    <h4 class="text-xl font-bold uppercase text-secondary">CHAINS – ROPES –<br>SHACKLES</h4>
                    <p class="mt-4 flex-1 text-sm font-medium leading-relaxed text-foreground/70">
                ...
                <div class="flex flex-col rounded-2xl border border-foreground/10 bg-secondary/5 p-8 shadow-sm transition hover:shadow-md">
                    ...
                    <h4 class="text-xl font-bold uppercase text-secondary">SAFETY EQUIPMENT</h4>
                    <p class="mt-4 flex-1 text-sm font-medium leading-relaxed text-foreground/70">
            ...
            <!-- Pagination -->
            <div class="mt-16 flex items-center justify-center gap-4 text-sm font-bold text-secondary">
                <span class="cursor-not-allowed opacity-50">Previous</span>
                <span class="flex h-8 w-8 items-center justify-center text-primary">1</span>
                <a href="#" class="flex h-8 w-8 items-center justify-center transition hover:text-primary">2</a>
                <a href="#" class="transition hover:text-primary">Next</a>
            </div>
        </div>
    </section>
@endsection
