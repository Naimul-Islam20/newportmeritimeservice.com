...
class OurServicesSubMenuController extends Controller
{
    private function menuOrFail(): Menu
    {
        $menu = Menu::ourServicesAdminMenu();
        abort_unless($menu, 404);

        return $menu;
    }

    private function assertTopLevelOurServicesItem(SubMenu $subMenu, Menu $menu): void
    {
    ...
    public function index(): View
    {
        ...
        return view('admin.our-services-sub-menus.index', [
            'menu' => $menu,
            'subMenus' => $subMenus,
        ]);
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.our-services-sub-menus.create', [
            'menu' => $menu,
    ...
    public function edit(SubMenu $sub_menu): View
    {
        ...
        $this->assertTopLevelOurServicesItem($sub_menu, $menu);

        return view('admin.our-services-sub-menus.edit', [
            'menu' => $menu,
            'subMenu' => $sub_menu,
        ]);
    }
