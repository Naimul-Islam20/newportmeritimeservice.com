...
use App\Policies\HonorableClientPagePolicy;
use App\Policies\HonorableClientPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(HonorableClientPage::class, HonorableClientPagePolicy::class);
        Gate::policy(HonorableClient::class, HonorableClientPolicy::class);
